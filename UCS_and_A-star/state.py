...
This file contains a class representing a HexBot environment state. You should make use of this class in the solver.
...
class State:
    ...
    May use this class and its functions. May add your own code to this class (e.g. get_successors function,
